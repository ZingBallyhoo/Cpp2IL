...
namespace Cpp2IL.Core
{
    public static class SharedState
    {
        ...
        //Methods
        public static readonly ConcurrentDictionary<ulong, MethodDefinition> MethodsByAddress = new ConcurrentDictionary<ulong, MethodDefinition>();
        public static readonly ConcurrentDictionary<ulong, List<MethodDefinition>> MethodsByAddress2 = new ConcurrentDictionary<ulong, List<MethodDefinition>>();
        ...
        public static readonly ConcurrentDictionary<TypeDefinition, Il2CppTypeDefinition> ManagedToUnmanagedTypes = new ConcurrentDictionary<TypeDefinition, Il2CppTypeDefinition>();
        ...
        public static readonly ConcurrentDictionary<TypeDefinition, List<FieldInType>> FieldsByType = new ConcurrentDictionary<TypeDefinition, List<FieldInType>>();
